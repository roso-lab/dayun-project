...
class SparkRos2(Node):
    def __init__(self):
        ...
        # Timer to call move2goal every 0.1 seconds
        self.routine_timer = self.create_timer(0.1, self.move2goal)
    ...
    def goalSubscriberCallback(self, msg):
        ...
        # print("goalSubscriberCallback: ", msg)
    ...
    def station_linear_vel(self, self_pose, goal_pose, constant=0.1):
        """See video: https://www.youtube.com/watch?v=Qh15Nol5htM."""
    ...
    def station_angular_vel(self, self_pose, goal_pose, constant=0.1):
    ...
    def move2goal(self):
        ...
        if self.euclidean_distance(self.goal_pose, self.self_pose) >= distance_tolerance:
            ...
            print("will publish: ", robo_vel_msg)
            self.robo_vel.publish(robo_vel_msg)
        else:
            self.rate.sleep()
            robo_vel_msg.linear.x = 0.0
            robo_vel_msg.linear.y = 0.0
            robo_vel_msg.linear.z = 0.0
            robo_vel_msg.angular.x = 0.0
            robo_vel_msg.angular.y = 0.0
            robo_vel_msg.angular.z = 0.0
